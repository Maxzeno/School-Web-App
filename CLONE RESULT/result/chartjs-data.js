...
if( $('#chart_1a').length > 0 ){
		var ctx1 = document.getElementById("chart_1a").getContext("2d");
		var data1 = {
			labels: ["January", "February", "March", "April", "May", "June", "July"],
			datasets: [
			{
	...
	if( $('#chart_1b').length > 0 ){
		var ctx1 = document.getElementById("chart_1b").getContext("2d");
		var data1 = {
			labels: ["January", "February", "March", "April", "May", "June", "July"],
			datasets: [
			{
